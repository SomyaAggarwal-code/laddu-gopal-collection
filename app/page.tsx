  ...
  <main>
    ...
    <main style={{
      ...
      <header style={{ textAlign: "center", marginBottom: "40px" }}>
        ...
        <p>
          Premium Dresses, Mukut, Jewellery & Accessories
        </p>
      ...
      <section style={{ marginTop: "50px" }}>
        ...
        <p>
          Want a customised dress or jewellery?
          Send us your idea on WhatsApp.
        </p>

        <a
          href="https://wa.me/917015053081"
          target="_blank"
        >
          WhatsApp Us
        </a>
